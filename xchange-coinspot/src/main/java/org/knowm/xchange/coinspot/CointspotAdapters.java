...
//    private static final Comparator<xCoinspotOrderbook.Order> orderComparator = Comparator.comparing(o -> o.rate);

    private static Comparator<LimitOrder> limitOrderComparator = Comparator.comparing(o -> o, LimitOrder::compareTo);
    ...
    private static List<LimitOrder> adaptOrderbookOrdders(List<CoinspotOrderbook.Order> orders, Order.OrderType side, CurrencyPair currencyPair) {
        List<LimitOrder> limitOrders = orders.stream().map(o ->
