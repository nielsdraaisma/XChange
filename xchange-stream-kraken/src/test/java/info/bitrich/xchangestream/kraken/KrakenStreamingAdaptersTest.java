...
public class KrakenStreamingAdaptersTest {
    ...
    public void testAdaptTickerMessage() throws IOException {
        JsonNode jsonNode = StreamingObjectMapperHelper.getObjectMapper().readTree(this.getClass().getResource("/ticker.json").openStream());
        Assert.assertNotNull(jsonNode);
    ...
    public void testAdaptTrades() throws IOException {
        JsonNode jsonNode = StreamingObjectMapperHelper.getObjectMapper().readTree(this.getClass().getResource("/trades.json").openStream());
        Assert.assertNotNull(jsonNode);
