  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    ExchangeSpecification spec =
        StreamingExchangeFactory.INSTANCE
            .createExchange(IndependentReserveStreamingExchange.class.getName())
            .getDefaultExchangeSpecification();
    IndependentReserveStreamingExchange exchange =
        (IndependentReserveStreamingExchange)
            StreamingExchangeFactory.INSTANCE.createExchange(spec);

    exchange.connect().blockingAwait();

    Disposable btcAudOrderbook =
        orderbooks(exchange, new CurrencyPair(Currency.USDC, Currency.AUD));
