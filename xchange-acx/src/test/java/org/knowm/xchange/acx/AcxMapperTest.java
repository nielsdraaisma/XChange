...
public class AcxMapperTest {
    ...
    public void shouldReturnPartiallyCancelled() {
        AcxOrder acxOrder = new AcxOrder("1", "buy", "limit", BigDecimal.ONE, BigDecimal.TEN, "cancel", "btcaud", new Date(), BigDecimal.ONE, new BigDecimal("0.5"), new BigDecimal("0.5"), 1);
    ...
    public void shouldReturnCancelled() {
        AcxOrder acxOrder = new AcxOrder("1", "buy", "limit", BigDecimal.ONE, BigDecimal.TEN, "cancel", "btcaud", new Date(), BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ZERO, 0);
        Order.OrderStatus status = mapper.mapOrderStatus(acxOrder);
