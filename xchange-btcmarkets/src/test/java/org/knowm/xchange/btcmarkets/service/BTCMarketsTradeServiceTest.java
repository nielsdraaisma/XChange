...
public class BTCMarketsTradeServiceTest extends BTCMarketsServiceTest {
  ...
  public void shouldPlaceMarketOrder() throws IOException {
    MarketOrder marketOrder =
        new MarketOrder.Builder(Order.OrderType.BID, CurrencyPair.BTC_AUD).originalAmount(new BigDecimal("10.00000000")).build();
  ...
  public void shouldPlaceLimitOrder() throws IOException {
    // given
    LimitOrder limitOrder = new LimitOrder.Builder(Order.OrderType.ASK, CurrencyPair.BTC_AUD)
    ...
    BTCMarketsPlaceOrderRequest expectedRequest = new BTCMarketsPlaceOrderRequest(
            "BTC-AUD",
            "20.00000000",
            "10.00000000",
            "Limit",
